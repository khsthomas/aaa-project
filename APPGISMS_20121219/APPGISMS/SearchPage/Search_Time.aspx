<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search_Time.aspx.cs" Inherits="APPGISMS.SearchPage.Search_Time" %>
                    ...
                    <td class="QueryBlack">
                        <asp:UpdatePanel ID="upTitle" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:DropDownList ID="selWeek" runat="server" DataSource='<%# getTimeType() %>' DataTextField="CL_DESC" DataValueField="CL_INF" Width="100" />
                ...
                <tr>
                    <td class="QueryListBlack" valign="top">
                        <asp:UpdatePanel ID="upTab" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <AjaxCTLToolkit:TabContainer ID="tcHospital" runat="server" ActiveTabIndex="0" Height="400px" Width="100%" ScrollBars="Auto">
                                    ...
                                    <AjaxCTLToolkit:TabPanel ID="tpHospital_List" runat="server" HeaderText="地圖查詢">
                                        <ContentTemplate>
                                            <asp:UpdatePanel ID="upResult" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
                                                <ContentTemplate>
                                                    <asp:Panel ID="panTitle" runat="server" Visible="False" CssClass="GridViewTitle">牙醫院所清單</asp:Panel>
                                                    <asp:GridView ID="gvHospital_Info" runat="server" Width="95%" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" GridLines="None" ShowFooter="True"
                                                        PageSize="13"  EmptyDataText="查無資料" HorizontalAlign="Center" DataKeyNames="HOSPITAL_SN" CssClass="GridViewStyle"
                                                        OnRowDataBound="gvHospital_Info_RowDataBound" OnPageIndexChanging="gvHospital_Info_PageIndexChanging" OnRowCommand="gvHospital_Info_RowCommand"
                                                        OnRowCreated="gvHospital_Info_RowCreated">
